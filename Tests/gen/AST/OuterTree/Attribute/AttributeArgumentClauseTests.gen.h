...
{
    std::string className = "OuterTree::AttributeArgumentClauseTests";
    auto testClass = std::make_unique<Soup::Syntax::InnerTree::UnitTests::OuterTreeAttributeArgumentClauseTests>();
    TestState state = { 0, 0 };
