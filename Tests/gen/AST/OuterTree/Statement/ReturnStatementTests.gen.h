...
TestState RunOuterTreeReturnStatementTests() 
 {
    ...
    state += RunTest(className, "GetChildrenNoExpression", [&testClass]() { testClass->GetChildrenNoExpression(); });
    state += RunTest(className, "GetChildrenWithExpression", [&testClass]() { testClass->GetChildrenWithExpression(); });
