...
TestState RunOuterTreeReturnStatementTests() 
 {
    ...
    state += SoupTest::RunTest(className, "GetChildrenNoExpression", [&testClass]() { testClass->GetChildrenNoExpression(); });
    state += SoupTest::RunTest(className, "GetChildrenWithExpression", [&testClass]() { testClass->GetChildrenWithExpression(); });
