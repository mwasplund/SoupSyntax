...
{
    std::string className = "OuterTree::IdentifierExpressionTests";
    auto testClass = std::make_unique<Soup::Syntax::InnerTree::UnitTests::OuterTreeIdentifierExpressionTests>();
    TestState state = { 0, 0 };
