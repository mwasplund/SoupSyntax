...
{
    std::string className = "InnerTree::DeclarationSpecifierSequenceTests";
    auto testClass = std::make_unique<Soup::Syntax::InnerTree::UnitTests::InnerTreeDeclarationSpecifierSequenceTests>();
    TestState state = { 0, 0 };
