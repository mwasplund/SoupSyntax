...
TestState RunParseSimpleDeclarationTests()
{
    ...
    state += RunTest(
        className,
        "SimplePrimitiveVariable[char32_t]",
    ...
    state += RunTest(
        className,
        "SimplePrimitiveVariable[wchar_t]",
    ...
    state += RunTest(
        className,
        "SimplePrimitiveVariable[unsigned]",
