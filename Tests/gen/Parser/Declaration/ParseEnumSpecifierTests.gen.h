...
TestState RunParseEnumSpecifierTests() 
 {
    ...
    TestState state = { 0, 0 };
    state += RunTest(className, "SingleSimpleEnumSpecifier", [&testClass]() { testClass->SingleSimpleEnumSpecifier(); });
    state += RunTest(className, "SingleEnumClassSpecifier", [&testClass]() { testClass->SingleEnumClassSpecifier(); });
