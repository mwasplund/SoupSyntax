...
namespace Soup::Syntax::UnitTests
{
    ...
    public:
        void Run()
        {
            SingleToken_Keywoard("alignas", CppLexer::AlignAs);
            SingleToken_Keywoard("asm", CppLexer::Asm);
            SingleToken_Keywoard("auto", CppLexer::Auto);
            SingleToken_Keywoard("bool", CppLexer::Bool);
            SingleToken_Keywoard("break", CppLexer::Break);
            SingleToken_Keywoard("case", CppLexer::Case);
            SingleToken_Keywoard("catch", CppLexer::Catch);
            SingleToken_Keywoard("char", CppLexer::Char);
            SingleToken_Keywoard("char16_t", CppLexer::Char16);
            SingleToken_Keywoard("char32_t", CppLexer::Char32);
            SingleToken_Keywoard("class", CppLexer::Class);
            SingleToken_Keywoard("const", CppLexer::Const);
            SingleToken_Keywoard("constexpr", CppLexer::ConstExpr);
            SingleToken_Keywoard("const_cast", CppLexer::ConstCast);
            SingleToken_Keywoard("continue", CppLexer::Continue);
            SingleToken_Keywoard("decltype", CppLexer::DeclType);
            SingleToken_Keywoard("default", CppLexer::Default);
            SingleToken_Keywoard("delete", CppLexer::Delete);
            SingleToken_Keywoard("do", CppLexer::Do);
            SingleToken_Keywoard("double", CppLexer::Double);
            SingleToken_Keywoard("dynamic_cast", CppLexer::DynamicCast);
            SingleToken_Keywoard("else", CppLexer::Else);
            SingleToken_Keywoard("enum", CppLexer::Enum);
            SingleToken_Keywoard("explicit", CppLexer::Explicit);
            SingleToken_Keywoard("export", CppLexer::Export);
            SingleToken_Keywoard("extern", CppLexer::Extern);
            SingleToken_Keywoard("false", CppLexer::False);
            SingleToken_Keywoard("float", CppLexer::Float);
            SingleToken_Keywoard("for", CppLexer::For);
            SingleToken_Keywoard("friend", CppLexer::Friend);
            SingleToken_Keywoard("goto", CppLexer::GoTo);
            SingleToken_Keywoard("if", CppLexer::If);
            SingleToken_Keywoard("inline", CppLexer::Inline);
            SingleToken_Keywoard("int", CppLexer::Int);
            SingleToken_Keywoard("long", CppLexer::Long);
            SingleToken_Keywoard("mutable", CppLexer::Mutable);
            SingleToken_Keywoard("namespace", CppLexer::Namespace);
            SingleToken_Keywoard("new", CppLexer::New);
            SingleToken_Keywoard("noexcept", CppLexer::NoExcept);
            SingleToken_Keywoard("nullptr", CppLexer::Nullptr);
            SingleToken_Keywoard("operator", CppLexer::Operator);
            SingleToken_Keywoard("private", CppLexer::Private);
            SingleToken_Keywoard("protected", CppLexer::Protected);
            SingleToken_Keywoard("public", CppLexer::Public);
            SingleToken_Keywoard("register", CppLexer::Register);
            SingleToken_Keywoard("reinterpret_cast", CppLexer::ReinterpretCast);
            SingleToken_Keywoard("return", CppLexer::Return);
            SingleToken_Keywoard("short", CppLexer::Short);
            SingleToken_Keywoard("signed", CppLexer::Signed);
            SingleToken_Keywoard("sizeof", CppLexer::SizeOf);
            SingleToken_Keywoard("static", CppLexer::Static);
            SingleToken_Keywoard("static_assert", CppLexer::StaticAssert);
            SingleToken_Keywoard("static_cast", CppLexer::StaticCast);
            SingleToken_Keywoard("struct", CppLexer::Struct);
            SingleToken_Keywoard("switch", CppLexer::Switch);
            SingleToken_Keywoard("template", CppLexer::Template);
            SingleToken_Keywoard("this", CppLexer::This);
            SingleToken_Keywoard("thread_local", CppLexer::ThreadLocal);
            SingleToken_Keywoard("throw", CppLexer::Throw);
            SingleToken_Keywoard("true", CppLexer::True);
            SingleToken_Keywoard("try", CppLexer::Try);
            SingleToken_Keywoard("typedef", CppLexer::TypeDef);
            SingleToken_Keywoard("typeid", CppLexer::TypeId);
            SingleToken_Keywoard("typename", CppLexer::TypeName);
            SingleToken_Keywoard("union", CppLexer::Union);
            SingleToken_Keywoard("unsigned", CppLexer::Unsigned);
            SingleToken_Keywoard("using", CppLexer::Using);
            SingleToken_Keywoard("virtual", CppLexer::Virtual);
            SingleToken_Keywoard("void", CppLexer::Void);
            SingleToken_Keywoard("volatile", CppLexer::Volatile);
            SingleToken_Keywoard("wchar_t", CppLexer::WChar);
            SingleToken_Keywoard("while", CppLexer::While);
        }
